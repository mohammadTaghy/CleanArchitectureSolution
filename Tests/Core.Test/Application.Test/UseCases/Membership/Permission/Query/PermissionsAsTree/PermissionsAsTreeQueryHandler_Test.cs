...
{
    public class PermissionsAsTreeQueryHandler_Test : UnitTestBase<RolesPermission, IRolesPermissionRepo, IValidationRuleBase<RolesPermission>>
    {
        ...
        {
            _query = new PermissionsAsTreeQuery(1);
